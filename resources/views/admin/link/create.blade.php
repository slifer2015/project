                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('type',['هوایی'=>'هوایی','دریایی'=>'دریایی','زمینی'=>'زمینی','متفرقه'=>'متفرقه'],null,['class'=>'form-control select-status','id'=>'type']) !!}
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="submit" value="new" class="btn btn-success">ایجاد و جدید</button>
                            <button type="submit" name="submit" value="close" class="btn btn-success">ایجاد</button>
